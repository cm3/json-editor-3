...
var name_array = this.formname.match(/\[([^\[\s]+)\]/g);
if (name_array == null) name_array= [this.formname];
var e_name_len = name_array && name_array.length - 1 ;
var prop_name = name_array[ e_name_len ].replace("[","").replace("]","");
if(typeof p_node.options.table_row !== "undefined") p_node = p_node.parent;
if(typeof p_node.schema.suggestAPI !== "undefined"){
	// alert("add suggest attribute");
	this.input.setAttribute('suggestAPI',p_node.schema.suggestAPI);
}
// 2017.04 Add [E]
